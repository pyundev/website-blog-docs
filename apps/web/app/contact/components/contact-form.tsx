...
const ContactForm = () => {
  return (
    <div className="w-full py-20 mt-20 lg:py-40 min-h-screen">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
            Have questions about Datamizu? I'd love to hear from you. Send me an
            email and I'll get back to you as soon as possible.
          </p>
          <a
            href="mailto:albertoslavica@datamizu.com"
            className="inline-flex items-center gap-2 text-primary hover:underline"
          >
            albertoslavica@datamizu.com
